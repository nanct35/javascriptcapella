...
//check input of fields below
//for username check against alphanumeric and report error if blank error required field
...
//for password check length is 8 or greater and error also if blank as required field
...
//ensure password verify field same as password as well as required field
...
//first name must be aphanumeric and is required - produce errors if either condition not met
...
//last name must be aplhanumeric and is required - produce errors if either condition not met
...
//email must meet format below or error
function checkEmail(){
    msg("email", "");
    let error = "";
...
//phone number must meet format below or error
...
//look for the change and review each field going to place cursor on first error
